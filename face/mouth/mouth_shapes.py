...
MOUTH_PRESETS: Dict[str, MouthParams] = {
    "calm": MouthParams(
        ...
        height=16.0,
        thickness=14.0,
        upper_curvature=0.05,
        lower_curvature=0.05,
        smile_amount=0.08,
        corner_roundness=1.0,
        opening=0.0,
    ),
    "happy": MouthParams(
        ...
        lower_curvature=0.45,
        smile_amount=0.70,
        corner_roundness=1.0,
        opening=0.0,  # Predominantly solid white shape (no inner cavity)
    ),
    "caring": MouthParams(
        width=82.0,
        height=24.0,
        thickness=16.0,
        upper_curvature=0.35,
        lower_curvature=0.28,
        smile_amount=0.42,
        corner_roundness=1.0,
        opening=0.0,  # Predominantly solid white shape
    ),
    "speaking": MouthParams(
        ...
        smile_amount=0.08,
        corner_roundness=1.0,
        opening=0.0,  # Placeholder neutral mouth
    ),
    "thinking": MouthParams(
        ...
        offset_x=0.0,  # No permanent static skew; animated motion in controller
        rotation=0.0,
        opening=0.0,
    ),
    "sad": MouthParams(
        ...
        height=26.0,
        thickness=16.0,
        upper_curvature=-0.45,
        lower_curvature=-0.38,
        smile_amount=-0.55,
        corner_roundness=0.95,
        opening=0.0,  # Solid white downward arch
    ),
    "surprised": MouthParams(
        ...
        smile_amount=0.0,
        corner_roundness=1.0,
        opening=0.85,  # Inner cavity required for Surprised O-shape
    ),
    "sleepy": MouthParams(
        width=58.0,
        height=12.0,
    ...
    "listening": MouthParams(
        ...
        height=18.0,
        thickness=15.0,
        upper_curvature=0.18,
        lower_curvature=0.12,
        smile_amount=0.22,
        corner_roundness=1.0,
        opening=0.0,
    ),
